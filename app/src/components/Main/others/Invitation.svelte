...
<section class="grid place-items-center mt-30 gap-10 px-5 xl:grid-cols-2 xl:text-2xl">
    <div class="text-center flex flex-col items-center gap-5">
        <p class="font-bold text-2xl">Sermon</p>
    ...
    <div class="flex gap-2">
        <div class="w-40 h-50 rounded-xl">
            <img src="/testimonies/img1.jpeg" alt="" class="bg-cover bg-center">
        </div>
        <div class="w-40 h-70 rounded-xl">
            <img src="/testimonies/img1.jpeg" alt="" class="bg-cover bg-center">
        </div>
    </div>
</section>